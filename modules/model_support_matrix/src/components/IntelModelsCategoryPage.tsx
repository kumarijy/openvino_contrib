/**
 * IntelModelsCategoryPage - Shows specific category models
 */

import React, { useState } from 'react';
import { ArrowLeftIcon, TableCellsIcon, Squares2X2Icon } from '@heroicons/react/24/outline';

interface IntelModelsCategoryPageProps {
  category: string;
  models: Array<{
    name: string;
    description: string;
...
export const IntelModelsCategoryPage: React.FC<IntelModelsCategoryPageProps> = ({
  category,
  models,
  onNavigateBack,
}) => {
