...
enum ModelId {
  ...
  DEEPSEEK_CODER_1_3B_INT8 = 'kumarijy/deepseek-coder-1_3b-instruct-openvino-int8',
  REFACT_FIM_1_6B_INT8 = 'kumarijy/Refact-1_6B-fim-openvino-int8',
  //REFACT_FIM_1_6B_INT8 = 'kumarijy/refact-1_6B-fim-openvino',
}
...
export enum ModelName {
  ...
  DEEPSEEK_CODER_1_3B_INT8 = 'deepseek-coder',
  REFACT_FIM_1_6B_INT8 = 'fim-refact',
}
...
export const MODEL_NAME_TO_ID_MAP: Record<ModelName, ModelId> = {
  ...
  [ModelName.DEEPSEEK_CODER_1_3B_INT8]: ModelId.DEEPSEEK_CODER_1_3B_INT8,
  [ModelName.REFACT_FIM_1_6B_INT8]: ModelId.REFACT_FIM_1_6B_INT8,
};
...
export const MODEL_SUPPORTED_FEATURES: Record<ModelName, Features[]> = {
  ...
  [ModelName.DEEPSEEK_CODER_1_3B_INT8]: [Features.CODE_COMPLETION, Features.SUMMARIZATION, Features.FIM],
  [ModelName.REFACT_FIM_1_6B_INT8]: [Features.CODE_COMPLETION, Features.SUMMARIZATION, Features.FIM],
};
